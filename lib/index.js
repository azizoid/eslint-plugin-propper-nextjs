...
const nextjsDefaultExportRule = ("./rules/nextjs-default-export-rule")

const propperNextJsPlugin = {
  rules: {
    "nextjs-default-export-rule": nextjsDefaultExportRule,
...
propperNextJsPlugin.configs = {
  recommended: {
    ...
    rules: {
      ...
      "propper-nextjs/custom-utility-rule": "warn",
